public class cal extends javax.swing.JFrame {
    ...
    private void equaActionPerformed(java.awt.event.ActionEvent evt) {                                     
        a=Double.valueOf(s2);
        b=Double.valueOf(s1);
        String e="";
        his=his+s1;
    ...
    private void txtmActionPerformed(java.awt.event.ActionEvent evt) {                                     
   ...
   his="";
    ...
    private void negActionPerformed(java.awt.event.ActionEvent evt) {                                    
        s1="-"+s1;
     txtm.setText(s1);
    }                                   
